...
ax.bar(range(1, 13), campo_mourao['precipitation'], label="Precipitation", align='center')
...
ax.bar(range(1, 13), jaguaruana['precipitation'], label="Precipitation", align='center')

ax.fill_between(np.array(range(1, 13)), np.array(jaguaruana['storage']), np.array(jaguaruana['def']),
                where=np.array(jaguaruana['storage']) >= np.array(jaguaruana['def']), facecolor='blue', interpolate=True)

# ax.fill_between(range(1, 13), jaguaruana['storage'], jaguaruana['def'],
#                 where=jaguaruana['storage'] < jaguaruana['def'], facecolor='red', interpolate=True)
